									...
									<div class="entry">
										<?php
											...
											<table border="0" width="100%">
												 ...
												 {
													echo ' <td><a href="process_cart.php?nm='.$row['b_nm'].'&cat='.$_GET['cat'].'&rate='.$row['b_price'].'&id='.$id.'">
												...
												{
													echo '<td>  <button type="button" class="btn btn-primary btn-lg">Add Cart</button>
<br><a href="register.php"> <h4>Please Login..</h4></a></td>';
												}
												echo '</tr>
											</table>';
										?>
